...
| 문서 | 연관 이유 |
|------|---------|
| [05_ai_navigation.md](05_ai_navigation.md) | NavMesh — Mass AI Processor가 경로 탐색에 NavMesh를 활용 |
| [44_character_movement.md](44_character_movement.md) | 군중 이동 로직 — CharacterMovement 대비 Mass 이동 트레이드오프 |
| [43_foliage_system.md](43_foliage_system.md) | HISM — Foliage와 Mass Entity의 대규모 인스턴스 렌더링 비교 |
| [40_world_partition.md](40_world_partition.md) | World Partition — 스트리밍 셀 단위 Entity 활성화/비활성화 |
| [53_profiling_optimization.md](53_profiling_optimization.md) | Mass Processor 퍼포먼스 — Insights로 Entity 처리 비용 측정 |
| [11_pcg_procedural.md](11_pcg_procedural.md) | PCG — 절차적으로 생성된 오브젝트를 Mass Entity로 구동 |

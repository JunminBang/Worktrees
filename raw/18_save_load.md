...
| 문서 | 연관 이유 |
|------|---------|
| [01_gameplay_framework.md](01_gameplay_framework.md) | GameInstance — 맵 전환 후에도 SaveGame 캐싱에 사용 |
| [16_data_management.md](16_data_management.md) | DataTable/DataAsset — 저장할 게임 데이터 구조 설계 |
| [06_ui_cinematics.md](06_ui_cinematics.md) | UI — 세이브/로드 메뉴 버튼 이벤트 연동 |
| [13_online_multiplayer.md](13_online_multiplayer.md) | 온라인 세션 — 클라우드 세이브 vs 로컬 세이브 차이 |
| [21_blueprint_advanced.md](21_blueprint_advanced.md) | Blueprint 패턴 — 세이브 시스템 이벤트 디스패처 연동 |
